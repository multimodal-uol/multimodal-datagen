...
class RandomForestClassifier(ClassifierMixin, BaseAlgo):
    def __init__(self, options):
        ...
        self.estimator = _RandomForestClassifier(class_weight='balanced', **out_params)
    ...
    def register_codecs():
        ...
        codecs_manager.add_codec(
            'sklearn.ensemble.forest', 'RandomForestClassifier', SimpleObjectCodec
        )
        codecs_manager.add_codec(
            'sklearn.tree.tree', 'DecisionTreeClassifier', SimpleObjectCodec
        )
