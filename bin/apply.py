...
from util.telemetry_util import log_uuid, log_apply_time, Timer, log_experiment_details
...
class ApplyCommand(BaseChunkHandler):
    ...
    def _setup_watchdog(self):
        ...
        self.watchdog = command_util.get_watchdog(
            time_limit=-1, memory_limit=self.controller.resource_limits['max_memory_usage_mb']
        )
        self.watchdog.start()
    ...
    def setup(self):
        ...
        exec_type = CommandType.STREAMING if streaming_apply else CommandType.STATEFUL
