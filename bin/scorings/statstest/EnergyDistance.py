...
class EnergyDistanceScoring(DoubleArrayScoringMixin, BaseScoring):
    """ Implements scipy.stats.energy_distance """

    def handle_options(self, options):
        """ energy_distance requires each array to be made of exactly 1 field. """
        params = options.get('params', {})
        params = EnergyDistanceScoring.convert_param_types(params)
